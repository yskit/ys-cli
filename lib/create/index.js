...
function createAction(name, cwd) {
  return async thread => {
    ...
    const appPublicDir = path.resolve(appDir, 'public');
    const appExtendDir = path.resolve(appDir, 'extend');
    ...
    fs.mkdirSync(appPublicDir);
    fs.mkdirSync(appExtendDir);
    ...
    fileList.push(actions['/app/extend/empty.js'](projectDirPath, path.resolve(appExtendDir, 'context.js')));
    fileList.push(actions['/app/extend/empty.js'](projectDirPath, path.resolve(appExtendDir, 'request.js')));
    fileList.push(actions['/app/extend/empty.js'](projectDirPath, path.resolve(appExtendDir, 'response.js')));
    fileList.push(actions['/app/extend/empty.js'](projectDirPath, path.resolve(appExtendDir, 'application.js')));
